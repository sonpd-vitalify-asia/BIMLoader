...
var Vs = (i, t, e) => t in i ? Fs(i, t, { enumerable: true, configurable: true, writable: true, value: e }) : i[t] = e;
...
function nn(i, t, e) {
  ...
  const r = Et(t), o = Dn(t), a = Nn(o), l = K(t), c = r === "y", u = s.x + s.width / 2 - n.width / 2, d = s.y + s.height / 2 - n.height / 2, f = s[a] / 2 - n[a] / 2;
  let p;
  switch (l) {
    case "top":
      p = {
...
var Js = async (i, t, e) => {
  ...
  for (let v = 0; v < a.length; v++) {
    ...
    }, k && b <= 50 && (b++, typeof k == "object" && (k.placement && (f = k.placement), k.rects && (c = k.rects === true ? await o.getElementRects({
      reference: i,
      floating: t,
      strategy: n
    }) : k.rects), {
...
async function Vn(i, t) {
  ...
  const {
    ...
    altBoundary: f = false,
    padding: p = 0
  } = ce(t, i), b = Fn(p), g = a[f ? d === "floating" ? "reference" : "floating" : d], S = Rt(await r.getClippingRect({
    ...
    x: 1,
    y: 1
  }, k = Rt(r.convertOffsetParentRelativeRectToViewportRelativeRect ? await r.convertOffsetParentRelativeRectToViewportRelativeRect({
    elements: a,
    rect: E,
    offsetParent: x,
    strategy: l
  ...
  return {
    top: (S.top - k.top + b.top) / $.y,
    bottom: (k.bottom - S.bottom + b.bottom) / $.y,
    left: (S.left - k.left + b.left) / $.x,
    right: (k.right - S.right + b.right) / $.x
  };
}
var Ks = function(i) {
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      ...
      if ((e = r.arrow) != null && e.alignmentOffset)
        return {};
      const S = K(n), E = Et(a), x = K(a) === a, $ = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), k = f || (x || !v ? [Ce(a)] : Qs(a)), _ = b !== "none";
      !f && _ && k.push(...Ys(a, v, b, $));
      const I = [a, ...k], D = await Vn(t, g), F = [];
      ...
      if (A = [...A, {
        ...
        var Ot, Qt;
        const W = (((Ot = r.flip) == null ? void 0 : Ot.index) || 0) + 1, Tt = I[W];
        if (Tt)
          return {
            data: {
              index: W,
...
function Un(i) {
  const t = Mt(...i.map((r) => r.left)), e = Mt(...i.map((r) => r.top)), s = J(...i.map((r) => r.right)), n = J(...i.map((r) => r.bottom));
  return {
    x: t,
    y: e,
    width: s - t,
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: l,
        y: c
      } = ce(i, t), u = Array.from(await (r.getClientRects == null ? void 0 : r.getClientRects(s.reference)) || []), d = Zs(u), f = Rt(Un(u)), p = Fn(a);
      function b() {
        ...
        if (d.length >= 2) {
          if (Et(e) === "y") {
            const A = d[0], Ot = d[d.length - 1], Qt = K(e) === "top", Pt = A.top, W = Ot.bottom, Tt = Qt ? A.left : Ot.left, nt = Qt ? A.right : Ot.right, st = nt - Tt, Q = W - Pt;
            return {
              top: Pt,
              bottom: W,
              left: Tt,
          ...
          const g = K(e) === "left", S = J(...d.map((A) => A.right)), E = Mt(...d.map((A) => A.left)), x = d.filter((A) => g ? A.left === E : A.right === S), $ = x[0].top, k = x[x.length - 1].bottom, _ = E, I = S, D = I - _, F = k - $;
          return {
            top: $,
            bottom: k,
            left: _,
...
async function er(i, t) {
  const {
    ...
    platform: s,
    elements: n
  } = i, r = await (s.isRTL == null ? void 0 : s.isRTL(n.floating)), o = K(e), a = He(e), l = Et(e) === "y", c = ["left", "top"].includes(o) ? -1 : 1, u = r && l ? -1 : 1, d = ce(t, i);
  let {
    mainAxis: f,
    crossAxis: p,
    alignmentAxis: b
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: e,
        y: s
      }, u = await Vn(t, l), d = Et(K(n)), f = Hn(d);
      let p = c[f], b = c[d];
      if (r) {
...
function ut(i) {
  return Wn(i) ? (i.nodeName || "").toLowerCase() : "#document";
}
function z(i) {
  var t;
...
function gt(i) {
  var t;
  return (t = (Wn(i) ? i.ownerDocument : i.document) || window.document) == null ? void 0 : t.documentElement;
}
function Wn(i) {
  return Ne() ? i instanceof Node || i instanceof z(i).Node : false;
}
function G(i) {
  return Ne() ? i instanceof Element || i instanceof z(i).Element : false;
}
function Y(i) {
  return Ne() ? i instanceof HTMLElement || i instanceof z(i).HTMLElement : false;
}
function sn(i) {
  return !Ne() || typeof ShadowRoot > "u" ? false : i instanceof ShadowRoot || i instanceof z(i).ShadowRoot;
}
function ue(i) {
  const {
    overflow: t,
...
function vi(i) {
  const t = yi(), e = G(i) ? j(i) : i;
  return ["transform", "translate", "scale", "rotate", "perspective"].some((s) => e[s] ? e[s] !== "none" : false) || (e.containerType ? e.containerType !== "normal" : false) || !t && (e.backdropFilter ? e.backdropFilter !== "none" : false) || !t && (e.filter ? e.filter !== "none" : false) || ["transform", "translate", "scale", "rotate", "perspective", "filter"].some((s) => (e.willChange || "").includes(s)) || ["paint", "layout", "strict", "content"].some((s) => (e.contain || "").includes(s));
}
function rr(i) {
  let t = zt(i);
  for (; Y(t) && !De(t); ) {
...
function Qn(i) {
  const t = zt(i);
  return De(t) ? i.ownerDocument ? i.ownerDocument.body : i.body : Y(t) && ue(t) ? t : Qn(t);
}
function Gn(i, t, e) {
  var s;
  t === void 0 && (t = []);
  const n = Qn(i), r = n === ((s = i.ownerDocument) == null ? void 0 : s.body), o = z(n);
  return r ? (or(o), t.concat(o, o.visualViewport || [], ue(n) ? n : [], [])) : t.concat(n, Gn(n, []));
}
function or(i) {
...
function Yn(i) {
  ...
  const n = Y(i), r = n ? i.offsetWidth : e, o = n ? i.offsetHeight : s, a = $e(e) !== r || $e(s) !== o;
  return a && (e = r, s = o), {
    width: e,
    height: s,
    $: a
...
function ee(i, t, e, s) {
  ...
  let o = ct(1);
  t && (s ? G(s) && (o = Lt(s)) : o = Lt(i));
  const a = ar(r, e, s) ? Jn(r) : ct(0);
  let l = (n.left + a.x) / o.x, c = (n.top + a.y) / o.y, u = n.width / o.x, d = n.height / o.y;
  if (r) {
    const f = z(r), p = s && G(s) ? z(s) : s;
    ...
    for (; v && s && p !== b; ) {
      ...
      l *= g.x, c *= g.y, u *= g.x, d *= g.y, l += x, c += $, b = z(v), v = b.frameElement;
    }
  }
  return Rt({
    width: u,
...
function ur(i) {
  ...
  const r = n === "fixed", o = gt(s), a = t ? Kn(t.floating) : false;
  if (s === o || a && r)
    return e;
  let l = {
    scrollLeft: 0,
  ...
  const u = ct(0), d = Y(s);
  if ((d || !d && !r) && ((ut(s) !== "body" || ue(o)) && (l = Fe(s)), Y(s))) {
    const f = ee(s);
...
function pr(i, t) {
  const e = ee(i, true, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, r = Y(i) ? Lt(i) : ct(1), o = i.clientWidth * r.x, a = i.clientHeight * r.y, l = n * r.x, c = s * r.y;
  return {
    width: o,
    height: a,
    x: l,
...
function ts(i, t) {
  const e = zt(i);
  return e === t || !G(e) || De(e) ? false : j(e).position === "fixed" || ts(e, t);
}
function mr(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let s = Gn(i, []).filter((a) => G(a) && ut(a) !== "body"), n = null;
  const r = j(i).position === "fixed";
  let o = r ? zt(i) : i;
  for (; G(o) && !De(o); ) {
    const a = j(o), l = vi(o);
    !l && a.position === "fixed" && (n = null), (r ? !l && !n : !l && a.position === "static" && !!n && ["absolute", "fixed"].includes(n.position) || ue(o) && !l && ts(i, o)) ? s = s.filter((u) => u !== o) : n = a, o = zt(o);
  }
  return t.set(i, s), s;
}
function br(i) {
  ...
  const o = [...e === "clippingAncestors" ? mr(t, this._c) : [].concat(e), s], a = o[0], l = o.reduce((c, u) => {
    const d = rn(t, u, n);
    return c.top = J(d.top, c.top), c.right = Mt(d.right, c.right), c.bottom = Mt(d.bottom, c.bottom), c.left = J(d.left, c.left), c;
  }, rn(t, a, n));
  return {
...
function vr(i, t, e) {
  const s = Y(t), n = gt(t), r = e === "fixed", o = ee(i, true, r, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
  const l = ct(0);
  if (s || !s && !r)
    if ((ut(t) !== "body" || ue(n)) && (a = Fe(t)), s) {
      const d = ee(t, true, r, t);
...
function on(i, t) {
  return !Y(i) || j(i).position === "fixed" ? null : t ? t(i) : i.offsetParent;
}
function es(i, t) {
  const e = z(i);
  if (!Y(i) || Kn(i))
  ...
  for (; s && nr(s) && j(s).position === "static"; )
    s = on(s, t);
  return s && (ut(s) === "html" || ut(s) === "body" && j(s).position === "static" && !vi(s)) ? e : s || rr(i) || e;
}
var yr = async function(i) {
...
var _e = globalThis;
var _i = _e.ShadowRoot && (_e.ShadyCSS === void 0 || _e.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype;
var xi = Symbol();
var ln = /* @__PURE__ */ new WeakMap();
var os = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = true, s !== xi)
  ...
  get styleSheet() {
    ...
    if (_i && t === void 0) {
      ...
      s && (t = ln.get(e)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), s && ln.set(e, t));
    }
    return t;
  }
  toString() {
...
var wr = (i) => new os(typeof i == "string" ? i : i + "", void 0, xi);
var C = (i, ...t) => {
...
var an = _i ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const s of t.cssRules)
    e += s.cssText;
  return wr(e);
})(i) : i;
var { is: Cr, defineProperty: Er, getOwnPropertyDescriptor: Sr, getOwnPropertyNames: Ar, getOwnPropertySymbols: kr, getPrototypeOf: Or } = Object;
var at = globalThis;
var cn = at.trustedTypes;
var Pr = cn ? cn.emptyScript : "";
var Xe = at.reactiveElementPolyfillSupport;
var Xt = (i, t) => i;
var Ee = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Pr : null;
      break;
...
var wi = (i, t) => !Cr(i, t);
var un = { attribute: true, type: String, converter: Ee, reflect: false, hasChanged: wi };
...
var It = class extends HTMLElement {
  ...
  static getPropertyOptions(t) {
    return this.elementProperties.get(t) ?? un;
  }
  static _$Ei() {
  ...
  static finalize() {
    if (this.hasOwnProperty(Xt("finalized")))
      return;
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(Xt("properties"))) {
      const e = this.properties, s = [...Ar(e), ...kr(e)];
      for (const n of s)
...
It.elementStyles = [], It.shadowRootOptions = { mode: "open" }, It[Xt("elementProperties")] = /* @__PURE__ */ new Map(), It[Xt("finalized")] = /* @__PURE__ */ new Map(), Xe == null || Xe({ ReactiveElement: It }), (at.reactiveElementVersions ?? (at.reactiveElementVersions = [])).push("2.0.4");
var Jt = globalThis;
var Se = Jt.trustedTypes;
var hn = Se ? Se.createPolicy("lit-html", { createHTML: (i) => i }) : void 0;
var ls = "$lit$";
var lt = `lit$${Math.random().toFixed(9).slice(2)}$`;
var as = "?" + lt;
var Tr = `<${as}>`;
var St = document;
var ie = () => St.createComment("");
var ne = (i) => i === null || typeof i != "object" && typeof i != "function";
var $i = Array.isArray;
var Ir = (i) => $i(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function";
var Je = `[ 	
\f\r]`;
var Gt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g;
var dn = /-->/g;
var fn = />/g;
var xt = RegExp(`>|${Je}(?:([^\\s"'>=/]+)(${Je}*=${Je}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g");
var pn = /'/g;
var mn = /"/g;
var cs = /^(?:script|style|textarea|title)$/i;
var Lr = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e });
var m = Lr(1);
var At = Symbol.for("lit-noChange");
var O = Symbol.for("lit-nothing");
var bn = /* @__PURE__ */ new WeakMap();
var wt = St.createTreeWalker(St, 129);
function us(i, t) {
  if (!$i(i) || !i.hasOwnProperty("raw"))
    throw Error("invalid template strings array");
  return hn !== void 0 ? hn.createHTML(t) : t;
}
var Mr = (i, t) => {
  const e = i.length - 1, s = [];
  let n, r = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", o = Gt;
  for (let a = 0; a < e; a++) {
    const l = i[a];
    let c, u, d = -1, f = 0;
    for (; f < l.length && (o.lastIndex = f, u = o.exec(l), u !== null); )
      f = o.lastIndex, o === Gt ? u[1] === "!--" ? o = dn : u[1] !== void 0 ? o = fn : u[2] !== void 0 ? (cs.test(u[2]) && (n = RegExp("</" + u[2], "g")), o = xt) : u[3] !== void 0 && (o = xt) : o === xt ? u[0] === ">" ? (o = n ?? Gt, d = -1) : u[1] === void 0 ? d = -2 : (d = o.lastIndex - u[2].length, c = u[1], o = u[3] === void 0 ? xt : u[3] === '"' ? mn : pn) : o === mn || o === pn ? o = xt : o === dn || o === fn ? o = Gt : (o = xt, n = void 0);
    const p = o === xt && i[a + 1].startsWith("/>") ? " " : "";
    r += o === Gt ? l + Tr : d >= 0 ? (s.push(c), l.slice(0, d) + ls + l.slice(d) + lt + p) : l + lt + (d === -2 ? a : p);
  }
...
var se = class _se {
  constructor({ strings: t, _$litType$: e }, s) {
    ...
    this.parts = [];
    let r = 0, o = 0;
    const a = t.length - 1, l = this.parts, [c, u] = Mr(t, e);
    if (this.el = _se.createElement(c, s), wt.currentNode = this.el.content, e === 2 || e === 3) {
        ...
        if (n.hasAttributes())
          for (const d of n.getAttributeNames())
            if (d.endsWith(ls)) {
              ...
              l.push({ type: 1, index: r, name: b[2], strings: p, ctor: b[1] === "." ? zr : b[1] === "?" ? jr : b[1] === "@" ? Br : Ve }), n.removeAttribute(d);
            } else
...
function jt(i, t, e = i, s) {
  ...
  return (n == null ? void 0 : n.constructor) !== r && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, false), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = jt(i, n._$AS(i, t.values), n, s)), t;
}
var Rr = class {
  constructor(t, e) {
  ...
  u(t) {
    const { el: { content: e }, parts: s } = this._$AD, n = ((t == null ? void 0 : t.creationScope) ?? St).importNode(e, true);
    wt.currentNode = n;
    let r = wt.nextNode(), o = 0, a = 0, l = s[0];
    for (; l !== void 0; ) {
      if (o === l.index) {
        let c;
        l.type === 2 ? c = new he(r, r.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(r, l.name, l.strings, this, t) : l.type === 6 && (c = new Hr(r, this, t)), this._$AV.push(c), l = s[++a];
      }
...
var he = class _he {
  ...
  constructor(t, e, s, n) {
    this.type = 2, this._$AH = O, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = s, this.options = n, this._$Cv = (n == null ? void 0 : n.isConnected) ?? true;
  }
  get parentNode() {
  ...
  _$AI(t, e = this) {
    t = jt(this, t, e), ne(t) ? t === O || t == null || t === "" ? (this._$AH !== O && this._$AR(), this._$AH = O) : t !== this._$AH && t !== At && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ir(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== O && ne(this._$AH) ? this._$AA.nextSibling.data = t : this.T(St.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    var r;
  ...
  _$AC(t) {
    ...
    return e === void 0 && bn.set(t.strings, e = new se(t)), e;
  }
  k(t) {
    ...
    let s, n = 0;
    for (const r of t)
      n === e.length ? e.push(s = new _he(this.O(ie()), this.O(ie()), this, this.options)) : s = e[n], s._$AI(r), n++;
...
var Ve = class {
  ...
  constructor(t, e, s, n, r) {
    this.type = 1, this._$AH = O, this._$AN = void 0, this.element = t, this.name = e, this._$AM = n, this.options = r, s.length > 2 || s[0] !== "" || s[1] !== "" ? (this._$AH = Array(s.length - 1).fill(new String()), this.strings = s) : this._$AH = O;
  }
  _$AI(t, e = this, s, n) {
    ...
    if (r === void 0)
      ...
      for (t = r[0], l = 0; l < r.length - 1; l++)
        c = jt(this, a[s + l], e, l), c === At && (c = this._$AH[l]), o || (o = !ne(c) || c !== this._$AH[l]), c === O ? t = O : t !== O && (t += (c ?? "") + r[l + 1]), this._$AH[l] = c;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
var Br = class extends Ve {
  ...
  _$AI(t, e = this) {
    if ((t = jt(this, t, e, 0) ?? O) === At)
      return;
    const s = this._$AH, n = t === O && s !== O || t.capture !== s.capture || t.once !== s.once || t.passive !== s.passive, r = t !== O && (s === O || n);
...
var Ke = Jt.litHtmlPolyfillSupport;
...
var Bn;
w._$litElement$ = true, w.finalized = true, (Bn = globalThis.litElementHydrateSupport) == null || Bn.call(globalThis, { LitElement: w });
var Ze = globalThis.litElementPolyfillSupport;
Ze == null || Ze({ LitElement: w });
(globalThis.litElementVersions ?? (globalThis.litElementVersions = [])).push("4.1.1");
var Nr = { attribute: true, type: String, converter: Ee, reflect: false, hasChanged: wi };
var Dr = (i = Nr, t, e) => {
...
var hs = { ATTRIBUTE: 1, CHILD: 2 };
var ds = (i) => (...t) => ({ _$litDirective$: i, values: t });
var fs = class {
  constructor(t) {
  }
  get _$AU() {
...
var Kt = (i, t) => {
  ...
  if (e === void 0)
    return false;
  for (const n of e)
    (s = n._$AO) == null || s.call(n, t, false), Kt(n, t);
  return true;
};
var Ae = (i) => {
  let t, e;
...
var Nt = ds(class extends Wr {
  ...
  update(i, [t]) {
    var s;
    const e = t !== this.Y;
    return e && this.Y !== void 0 && this.rt(void 0), (e || this.lt !== this.ct) && (this.Y = t, this.ht = (s = i.options) == null ? void 0 : s.host, this.rt(this.ct = i.element)), O;
  }
  rt(i) {
...
function gn(i) {
  ...
  return t.width = e("width", null), t.height = e("height", null), t.rotate = Yr(e("rotate", "")), Jr(t, e("flip", "")), t.preserveAspectRatio = e("preserveAspectRatio", e("preserveaspectratio", "")), t;
}
function Kr(i, t) {
  for (const e in gs)
    if (i[e] !== t[e])
...
var xe = (i, t) => i ? !!((i.provider === "" || i.provider.match(Zt)) && (t && i.prefix === "" || i.prefix.match(Zt)) && i.name.match(Zt)) : false;
function Zr(i, t) {
  const e = {};
...
function vn(i, t) {
  const e = Zr(i, t);
  for (const s in oi)
    s in ke ? s in i && !(s in e) && (e[s] = ke[s]) : s in t ? e[s] = t[s] : s in i && (e[s] = i[s]);
  return e;
}
function to(i, t) {
...
function oe(i) {
  const t = typeof i == "string" ? fe(i, true, re) : i;
  if (t) {
    ...
    t.forEach((r) => {
      ...
      o.pending = o.pending.filter((l) => {
        ...
        if (i.icons[c])
          ...
          return e = true, true;
        return false;
      }), o.pending.length !== a && (e || ws([i], r.id), r.callback(
        o.loaded.slice(0),
        o.missing.slice(0),
        o.pending.slice(0),
        r.abort
...
function po(i, t, e, s) {
  ...
  function k() {
    ...
    f.push(I), c++, d = setTimeout(k, i.rotate), e(_, t, I.callback);
  }
...
var we = [];
for (; Yt.length > 0; )
  Yt.length === 1 || Math.random() > 0.5 ? we.push(Yt.shift()) : we.push(Yt.pop());
Ue[""] = Ei({
  resources: ["https://api.iconify.design"].concat(we)
});
function wn(i, t) {
  const e = Ei(t);
  return e === null ? false : (Ue[i] = e, true);
}
function qe(i) {
  return Ue[i];
}
...
function Cs(i, t, e) {
  ...
  if (typeof i == "string") {
    ...
    if (r) {
      s = $s(r);
      const o = i.resources ? i.resources[0] : "", a = ai(o);
      a && (n = a.send);
    }
  }
  return !s || !n ? (e(void 0, 424), $n) : s.query(t, n, e)().abort;
}
var Cn = "iconify2";
var le = "iconify";
var Es = le + "-count";
...
function ui(i, t) {
  return Si(i, Es, t.toString());
}
function hi(i) {
  return parseInt(ci(i, Es)) || 0;
}
var $t = {
  local: true,
  session: true
...
function Os(i, t) {
  ...
  const n = Math.floor(Date.now() / Ss) - go, r = (a) => {
    const l = le + a.toString(), c = ci(e, l);
    if (typeof c == "string") {
      try {
...
var ki = (i, t) => {
  ...
  return s.pending.forEach((l) => {
    ...
    const { provider: c, prefix: u } = l;
    n[c][u].length && $o(l, n[c][u]);
  }), t ? uo(t, s, r) : An;
};
var Co = (i) => new Promise((t, e) => {
  const s = typeof i == "string" ? fe(i, true) : i;
  if (!s) {
    e(i);
    return;
  }
...
var ko = /(-?[0-9.]*[0-9]+[0-9.]*)/g;
var Oo = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function di(i, t, e) {
  if (t === 1)
    return i;
...
var Lo = (i) => i === "unset" || i === "undefined" || i === "none";
function Is(i, t) {
  const e = {
    ...de,
    ...i
  ...
  [e, s].forEach((v) => {
    ...
    x % 2 === 1 && (n.left !== n.top && ($ = n.left, n.left = n.top, n.top = $), n.width !== n.height && ($ = n.width, n.width = n.height, n.height = $)), g.length && (r = Io(
      r,
      '<g transform="' + g.join(" ") + '">',
      "</g>"
    ));
  ...
  let u, d;
  o === null ? (d = a === null ? "1em" : a === "auto" ? c : a, u = di(d, l / c)) : (u = o === "auto" ? l : o, d = a === null ? di(u, c / l) : a === "auto" ? c : a);
  const f = {}, p = (v, g) => {
    Lo(g) || (f[v] = g.toString());
  };
...
function Ro(i) {
  return "data:image/svg+xml," + Mo(i);
}
function Ls(i) {
  return 'url("' + Ro(i) + '")';
}
...
function Rs() {
  ...
  return {
    enableCache: (e) => kn(e, true),
    disableCache: (e) => kn(e, false),
    iconLoaded: _n,
    iconExists: _n,
    getIcon: oo,
    listIcons: ro,
...
function Yo(i) {
  ...
  const n = Oi(i.body, e);
  return t.innerHTML = Go(n), t.firstChild;
}
function pi(i) {
...
function Ln(i, t) {
  const e = t.icon.data, s = t.customisations, n = Is(e, s);
    ...
    */
    ...
    _check() {
      ...
      if (!l.rendered || !this._visible)
        return;
      const u = this.getAttribute("mode"), d = gn(this);
      (l.attrMode !== u || Kr(l.customisations, d) || !pi(this._shadowRoot)) && this._renderIcon(l.icon, d, u);
    }
    /**
     ...
     */
    _gotIconData(l) {
      this._checkQueued = false, this._renderIcon(l, gn(this), this.getAttribute("mode"));
    }
    /**
     * Re-render based on icon data
     */
    _renderIcon(l, c, u) {
      const d = Ao(l.data.body, u), f = this._state.inline;
      Ln(this._shadowRoot, this._state = {
        rendered: true,
        icon: l,
        inline: f,
        customisations: c,
...
var y = class y2 {
   ...
   */
  static init() {
    y2.addGlobalStyles(), y2.defineCustomElement("bim-button", rl), y2.defineCustomElement("bim-checkbox", dt), y2.defineCustomElement("bim-color-input", Z), y2.defineCustomElement("bim-context-menu", bi), y2.defineCustomElement("bim-dropdown", V), y2.defineCustomElement("bim-grid", ae), y2.defineCustomElement("bim-icon", gi), y2.defineCustomElement("bim-input", kt), y2.defineCustomElement("bim-label", ft), y2.defineCustomElement("bim-number-input", M), y2.defineCustomElement("bim-option", T), y2.defineCustomElement("bim-panel", tt), y2.defineCustomElement("bim-panel-section", pt), y2.defineCustomElement("bim-selector", mt), y2.defineCustomElement("bim-table", R), y2.defineCustomElement("bim-tabs", X), y2.defineCustomElement("bim-tab", L), y2.defineCustomElement("bim-table-cell", Me), y2.defineCustomElement("bim-table-children", Re), y2.defineCustomElement("bim-table-group", ze), y2.defineCustomElement("bim-table-row", et), y2.defineCustomElement("bim-text-input", B), y2.defineCustomElement("bim-toolbar", Ft), y2.defineCustomElement("bim-toolbar-group", Dt), y2.defineCustomElement(
      "bim-toolbar-section",
      bt
    ), y2.defineCustomElement("bim-viewport", je);
  }
  static newRandomId() {
...
var We = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i;
var tl = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function Rn(i) {
  const t = tl.find(
    (a) => i.split(a).length === 2
  ), e = i.split(t).map((a) => a.trim()), [s, n] = e, r = n.startsWith("'") && n.endsWith("'") ? n.replace(/'/g, "") : We(n);
...
var Pi = (P = class extends w {
  ...
  async updatePosition() {
    ...
    const t = this.placement ?? "right", e = await rs(this._previousContainer, this, {
      placement: t,
      middleware: [qn(10), ss(), ns(), is({ padding: 5 })]
    }), { x: s, y: n } = e;
...
], Pi.prototype, "placement");
js([
  h({ type: Boolean, reflect: true })
], Pi.prototype, "visible");
var bi = Pi;
...
var H = (Ct = class extends w {
  constructor() {
    super(), this.labelHidden = false, this.active = false, this.disabled = false, this.vertical = false, this.tooltipVisible = false, this._stateBeforeLoading = {
      disabled: false,
      icon: ""
    }, this._loading = false, this._parent = Ht(), this._tooltip = Ht(), this._mouseLeave = false, this.onClick = (t) => {
...
var Li = class Li2 extends w {
  constructor() {
    super(...arguments), this.vertical = false, this.color = "#bcf124", this._colorInput = Ht(), this._textInput = Ht(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var Ri = class Ri2 extends Ie {
  constructor() {
    super(), this.multiple = false, this.required = false, this.vertical = false, this._visible = false, this._value = /* @__PURE__ */ new Set(), this.onValueChange = new Event("change"), this._contextMenu = Ht(), this.onOptionClick = (t) => {
...
var zi = class zi2 extends w {
  constructor() {
    super(...arguments), this.floating = false, this._layouts = {}, this._updateFunctions = {};
  }
  /**
  ...
  set layouts(t) {
    ...
    for (const [s, n] of Object.entries(t))
      for (const r in n.elements)
        e[s] || (e[s] = {}), e[s][r] = (o) => {
          const a = this._updateFunctions[s];
          if (!a)
            return;
          const l = a[r];
          l && l(o);
    ...
    if (this.layout) {
      if (this._updateFunctions = {}, this.layouts[this.layout]) {
        ...
        const t = this._updateFunctions[this.layout], e = this.layouts[this.layout], n = this.getLayoutAreas(e).map((r) => {
          ...
          if ("template" in o) {
            const { template: l, initialState: c } = o, [u, d] = Ie.create(l, c);
...
var Hi = class Hi2 extends w {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = false, this.slider = false, this._input = Ht(), this.onValueChange = new Event("change");
  }
  set value(t) {
...
var Ni = class Ni2 extends w {
   ...
   */
  get value() {
    return Le(this, this.valueTransform);
  }
  /**
...
var Di = class Di2 extends w {
  ...
  get value() {
    ...
    let e;
    return t instanceof tt && (e = t.valueTransform), Object.values(this.valueTransform).length !== 0 && (e = this.valueTransform), Le(this, e);
  }
  /**
  ...
  render() {
    ...
    if (this.data.children) {
      a = document.createElement(
        "bim-table-children"
      ), this._children = a, a.table = this.table, a.data = this.data.children;
...
], R.prototype, "headersHidden", 2);
q([
  h({ type: String, attribute: "min-col-width", reflect: true })
], R.prototype, "minColWidth", 2);
q([
  h({ type: Array, attribute: false })
], R.prototype, "columns", 1);
q([
  h({ type: Array, attribute: false })
], R.prototype, "data", 1);
q([
...
var Gi = class Gi2 extends w {
  ...
  onSlotChange(t) {
    ...
    const e = t.target.assignedElements(), s = e.find((n) => n instanceof L ? this.tab ? n.name === this.tab : !n.hidden : false);
    s && s instanceof L && (this.tab = s.name);
    for (const n of e) {
      if (!(n instanceof L)) {
        n.remove();
        continue;
    ...
    return m`
      ...
      >
        ${this.type === "area" ? m` <textarea
              ...
              .value=${this.value}
              .rows=${this.rows ?? 5}
              placeholder=${jn(this.placeholder)}
...
var fa = ds(class extends fs {
  ...
  update(i, [t]) {
    ...
    for (const s in t) {
      ...
      if (n != null) {
        this.ft.add(s);
        const r = typeof n == "string" && n.endsWith(Wl);
