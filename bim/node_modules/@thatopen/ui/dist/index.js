...
const Mt = Math.min, J = Math.max, $e = Math.round, ct = (i) => ({
  x: i,
  y: i
}), Us = {
  left: "right",
...
const Js = async (i, t, e) => {
  ...
  for (let v = 0; v < a.length; v++) {
    ...
    }, k && b <= 50 && (b++, typeof k == "object" && (k.placement && (f = k.placement), k.rects && (c = k.rects === !0 ? await o.getElementRects({
      reference: i,
      floating: t,
      strategy: n
    }) : k.rects), {
...
function Wn(i) {
  return Ne() ? i instanceof Node || i instanceof z(i).Node : !1;
}
function G(i) {
  return Ne() ? i instanceof Element || i instanceof z(i).Element : !1;
}
function Y(i) {
  return Ne() ? i instanceof HTMLElement || i instanceof z(i).HTMLElement : !1;
}
function sn(i) {
  return !Ne() || typeof ShadowRoot > "u" ? !1 : i instanceof ShadowRoot || i instanceof z(i).ShadowRoot;
}
function ue(i) {
  const {
    overflow: t,
...
function pr(i, t) {
  const e = ee(i, !0, t === "fixed"), s = e.top + i.clientTop, n = e.left + i.clientLeft, r = Y(i) ? Lt(i) : ct(1), o = i.clientWidth * r.x, a = i.clientHeight * r.y, l = n * r.x, c = s * r.y;
  return {
    width: o,
    height: a,
    x: l,
...
function ts(i, t) {
  const e = zt(i);
  return e === t || !G(e) || De(e) ? !1 : j(e).position === "fixed" || ts(e, t);
}
function mr(i, t) {
  const e = t.get(i);
  if (e)
...
function vr(i, t, e) {
  const s = Y(t), n = gt(t), r = e === "fixed", o = ee(i, !0, r, t);
  let a = {
    scrollLeft: 0,
    scrollTop: 0
  };
 ...
 */
const _e = globalThis, _i = _e.ShadowRoot && (_e.ShadyCSS === void 0 || _e.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, xi = Symbol(), ln = /* @__PURE__ */ new WeakMap();
let os = class {
  constructor(t, e, s) {
    if (this._$cssResult$ = !0, s !== xi)
...
const wr = (i) => new os(typeof i == "string" ? i : i + "", void 0, xi), C = (i, ...t) => {
...
}, an = _i ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Cr, defineProperty: Er, getOwnPropertyDescriptor: Sr, getOwnPropertyNames: Ar, getOwnPropertySymbols: kr, getPrototypeOf: Or } = Object, at = globalThis, cn = at.trustedTypes, Pr = cn ? cn.emptyScript : "", Xe = at.reactiveElementPolyfillSupport, Xt = (i, t) => i, Ee = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Pr : null;
      break;
  ...
  return e;
} }, wi = (i, t) => !Cr(i, t), un = { attribute: !0, type: String, converter: Ee, reflect: !1, hasChanged: wi };
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jt = globalThis, Se = Jt.trustedTypes, hn = Se ? Se.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, ls = "$lit$", lt = `lit$${Math.random().toFixed(9).slice(2)}$`, as = "?" + lt, Tr = `<${as}>`, St = document, ie = () => St.createComment(""), ne = (i) => i === null || typeof i != "object" && typeof i != "function", $i = Array.isArray, Ir = (i) => $i(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Je = `[ 	
\f\r]`, Gt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, dn = /-->/g, fn = />/g, xt = RegExp(`>|${Je}(?:([^\\s"'>=/]+)(${Je}*=${Je}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), pn = /'/g, mn = /"/g, cs = /^(?:script|style|textarea|title)$/i, Lr = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), m = Lr(1), At = Symbol.for("lit-noChange"), O = Symbol.for("lit-nothing"), bn = /* @__PURE__ */ new WeakMap(), wt = St.createTreeWalker(St, 129);
function us(i, t) {
...
function jt(i, t, e = i, s) {
  ...
  return (n == null ? void 0 : n.constructor) !== r && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, !1), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = jt(i, n._$AS(i, t.values), n, s)), t;
}
class Rr {
  constructor(t, e) {
...
class he {
  ...
  constructor(t, e, s, n) {
    this.type = 2, this._$AH = O, this._$AN = void 0, this._$AA = t, this._$AB = e, this._$AM = s, this.options = n, this._$Cv = (n == null ? void 0 : n.isConnected) ?? !0;
  }
  get parentNode() {
...
var Bn;
w._$litElement$ = !0, w.finalized = !0, (Bn = globalThis.litElementHydrateSupport) == null || Bn.call(globalThis, { LitElement: w });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Nr = { attribute: !0, type: String, converter: Ee, reflect: !1, hasChanged: wi }, Dr = (i = Nr, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const hs = { ATTRIBUTE: 1, CHILD: 2 }, ds = (i) => (...t) => ({ _$litDirective$: i, values: t });
let fs = class {
  constructor(t) {
  }
  get _$AU() {
...
const ti = /* @__PURE__ */ new WeakMap(), Nt = ds(class extends Wr {
  render(i) {
    return O;
  }
  update(i, [t]) {
...
const Ue = /* @__PURE__ */ Object.create(null), Yt = [
...
const Cn = "iconify2", le = "iconify", Es = le + "-count", En = le + "-version", Ss = 36e5, go = 168, vo = 50;
function ci(i, t) {
  try {
    return i.getItem(t);
  } catch {
...
const ko = /(-?[0-9.]*[0-9]+[0-9.]*)/g, Oo = /^-?[0-9.]*[0-9]+[0-9.]*$/g;
function di(i, t, e) {
  if (t === 1)
    return i;
...
const Lo = (i) => i === "unset" || i === "undefined" || i === "none";
function Is(i, t) {
  const e = {
    ...de,
    ...i
...
function Xo(i = "iconify-icon") {
  ...
  const n = [
    ...
    */
     ...
     */
    _gotIconData(l) {
      this._checkQueued = !1, this._renderIcon(l, gn(this), this.getAttribute("mode"));
    }
    /**
...
const Le = (i, t = {}, e = !0) => {
  ...
  return s;
}, We = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i, tl = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function Rn(i) {
  const t = tl.find(
...
var el = Object.defineProperty, il = Object.getOwnPropertyDescriptor, js = (i, t, e, s) => {
  for (var n = il(t, e), r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && el(t, e, n), n;
}, P;
const Pi = (P = class extends w {
  constructor() {
...
let rl = H;
var ol = Object.defineProperty, pe = (i, t, e, s) => {
...
var ll = Object.defineProperty, Ut = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && ll(t, e, n), n;
};
const Li = class Li extends w {
  constructor() {
    super(...arguments), this.vertical = !1, this.color = "#bcf124", this._colorInput = Ht(), this._textInput = Ht(), this.onValueChange = new Event("input"), this.onOpacityInput = (t) => {
      const e = t.target;
...
var al = Object.defineProperty, cl = Object.getOwnPropertyDescriptor, yt = (i, t, e, s) => {
...
var ul = Object.defineProperty, hl = Object.getOwnPropertyDescriptor, _t = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? hl(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
  return s && n && ul(t, e, n), n;
};
const Ri = class Ri extends Ie {
  constructor() {
    super(), this.multiple = !1, this.required = !1, this.vertical = !1, this._visible = !1, this._value = /* @__PURE__ */ new Set(), this.onValueChange = new Event("change"), this._contextMenu = Ht(), this.onOptionClick = (t) => {
...
var dl = Object.defineProperty, Bs = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && dl(t, e, n), n;
};
...
let gi = Be;
var fl = Object.defineProperty, Qe = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && fl(t, e, n), n;
};
...
var pl = Object.defineProperty, me = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && pl(t, e, n), n;
};
...
var ml = Object.defineProperty, bl = Object.getOwnPropertyDescriptor, N = (i, t, e, s) => {
...
const Hi = class Hi extends w {
  constructor() {
    super(...arguments), this._value = 0, this.vertical = !1, this.slider = !1, this._input = Ht(), this.onValueChange = new Event("change");
  }
  set value(t) {
...
var gl = Object.defineProperty, vl = Object.getOwnPropertyDescriptor, be = (i, t, e, s) => {
...
var yl = Object.defineProperty, ge = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && yl(t, e, n), n;
};
...
var _l = Object.defineProperty, ve = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && _l(t, e, n), n;
};
...
var Al = Object.defineProperty, kl = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Al(t, e, n), n;
};
...
var Pl = Object.defineProperty, Tl = Object.getOwnPropertyDescriptor, q = (i, t, e, s) => {
...
const Gi = class Gi extends w {
  ...
  onSlotChange(t) {
    ...
    const e = t.target.assignedElements(), s = e.find((n) => n instanceof L ? this.tab ? n.name === this.tab : !n.hidden : !1);
...
var Ml = Object.defineProperty, Rl = Object.getOwnPropertyDescriptor, Ge = (i, t, e, s) => {
 ...
 */
const jn = (i) => i ?? O;
var zl = Object.defineProperty, jl = Object.getOwnPropertyDescriptor, it = (i, t, e, s) => {
...
var Bl = Object.defineProperty, Hl = Object.getOwnPropertyDescriptor, Hs = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Hl(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
...
var Nl = Object.defineProperty, Dl = Object.getOwnPropertyDescriptor, Ye = (i, t, e, s) => {
...
var Fl = Object.defineProperty, Vl = Object.getOwnPropertyDescriptor, Ti = (i, t, e, s) => {
  for (var n = s > 1 ? void 0 : s ? Vl(t, e) : t, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = (s ? o(t, e, n) : o(n)) || n);
...
var Ul = Object.defineProperty, ql = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && Ul(t, e, n), n;
};
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ns = "important", Wl = " !" + Ns, fa = ds(class extends fs {
  constructor(i) {
    var t;
